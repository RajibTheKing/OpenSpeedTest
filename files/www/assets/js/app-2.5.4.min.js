...
(function(OpenSpeedTest) {
  ...
  openSpeedtestShow.prototype.ShowUI = function() {
    ...
    function uiLoaded(argument) {
      Status = "Loaded";
      console.log("[OpenSpeedTest] : Developed by Vishnu. Email --\x3e me@vishnu.pro, custom event added by RajibTheKing. Email --\x3e aporba.das@gmail.com");
    }
  };
    ...
    function OpenSpeedtest() {
      ...
      var Engine = setInterval(function() {
        ...
        if (Status === "SendR") {
          ...
          console.log('[OpenSpeedTest] : Network Metrics:', testResults);
          ...
          try {
            ...
            console.log('[OpenSpeedTest] : Could not communicate with parent window:', e.message);
          }
          var dummyElement = document.createElement("div");
